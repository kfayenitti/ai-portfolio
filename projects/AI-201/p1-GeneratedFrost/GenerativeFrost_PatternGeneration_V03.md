# Generative Frost Pattern Generation — V03

V03 is the **three-wrangle pipeline** with **carve-style growth** and a single `growth` control on the final wrangle.
...
- **V03:** this document — **three wrangles + Resample + Facet + one growth slider**.
