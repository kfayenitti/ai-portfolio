...
Capstone workspace: procedural frost in Houdini (VEX), with ComfyUI for ideation and Nuke for final comp.

## Start here

- **Position statement:** [`position-statement.md`](position-statement.md)
- **Current Houdini pipeline (V04):** [`GenerativeFrost_PatternGeneration_V04.md`](GenerativeFrost_PatternGeneration_V04.md) (inline VEX, network order, parms)
- **Pipeline overview:** [`system-maps/pipeline-architecture.md`](system-maps/pipeline-architecture.md)
...
| [`research/`](research/) | Practitioner notes, links, references |
| [`ideated_images/`](ideated_images/) | ComfyUI / generative ideation frames (reference only, not final pixels) |
